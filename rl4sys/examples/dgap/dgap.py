...
if __name__ == '__main__':
    ...
    parser.add_argument("--nv", type=int, help="Number of vertices")
    parser.add_argument("--ne", type=int, help="Number of edges")
    parser.add_argument("--base_file", type=str, help="Base file")
    parser.add_argument("--dynamic_file", type=str, help="Dynamic file")
