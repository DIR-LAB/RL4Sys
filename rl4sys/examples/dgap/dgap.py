...
class Vertex:
    """Represents a vertex in the graph with degree and index attributes."""
    def __init__(self, degree: int, index: int):
...
class DgapSim():
    ...
    def calculate_positions(self, start_vertex, end_vertex, gaps, total_degree):
        ...
        for i in range(start_vertex, end_vertex):
            ...
            # todo: more specifically, rl-agent should be called here to determine the gap for this vertex
...
if __name__ == '__main__':
    ...
    parser.add_argument("--nv", default=12, type=int, help="Number of vertices")
    parser.add_argument("--ne", default=20, type=int, help="Number of edges")
    ...
    #parser.add_argument("--number-of-moves", default=50, type=int, help="Number of moves")
