...
class HPCEnv(gym.Env):
    ...
    def uni_score(self,job):
        ...
        request_time = job.request_time
        # run_time = job.run_time
        return (request_time * request_processors + submit_time)
    ...
    def gen_preworkloads(self, size):
        ...
        for i in range(size):
            job = self.loads[self.np_random.integers(0, self.loads.size())]
    ...
    def refill_preworkloads(self):
        self.pre_workloads = []
        self.gen_preworkloads(self.np_random.integers(10, 50))
